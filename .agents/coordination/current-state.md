...
- **공동 감정 벽 구현 진행 (2026-08-13)**: 전시 별도 화면 `wall.html`과 iPad 결과 연결을 추가한다. 얼굴·사진·선택 경로·원본 표정 수치는 전송하지 않고, 대표 감정 다섯 종류의 KST 일일 합계만 Cloudflare Durable Object에 저장·표시한다. 설계: `docs/superpowers/specs/2026-08-13-emotion-wall-design.md`.
